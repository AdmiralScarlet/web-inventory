 ...
 <body>
             ...
             <div class="modal-body">
               <form action="?m=barangMasuk&s=simpan" method="POST" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" class="form-control" id="exampleInputEmail1" name="noinv" aria-describedby="emailHelp" placeholder="Masukkan Nomor Invoice" required>
              ...
              = {nama_brg:'" . addslashes($row['nama_brg']) . "',
                stok:'" . addslashes($row['stok']) . "', supplier:'" . addslashes($row['supplier']) . "'
                 ...
                 <div class="form-group">
                   ...
                   <input type="text" name="nama_brg" readonly aria-describedby="emailHelp" id="prd_nmbrg" size="67">
                 </div>

                <div class="form-group">
                    <label for="exampleInputEmail1">Stok</label>
                   <input type="text" class="form-control" id="prd_stk" name="stok" readonly aria-describedby="emailHelp" placeholder="Stok tidak dapat diubah">
                </div>
   ...
   <script>
     function generatePDF() {
       ...
       const headers = [
         ['No', 'ID Barang Masuk', 'Tanggal', 'No Invoice', 'Supplier', 'Kode Barang', 'Nama Barang', 'Stok', 'Jumlah Masuk', 'Jam', 'Petugas']
