           ...
           ?>
            ...
            <li class="dropdown">
              <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                <img src="../images/admin/<?php echo $r['foto']; ?>" height="50">
             </i> <?php echo $r['nama']; ?>
              </a>
              <ul class="dropdown-menu dropdown-user">
                <li>
                  <form class="" action="logout.php" method="post">
                    <button class="btn btn-default" type="submit" name="Logout"><i class="fa fa-sign-out"></i> Logout</button>
                  </form>
                </li>
              </ul>
            </li>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <input type="text"  class="form-control" id="exampleInputEmail1" name="no_brg_out" aria-describedby="emailHelp" placeholder="Masukkan Nomor Barang Keluar" required>
  ...
  <div class="form-group">
    ...
    <input type="text" readonly="" class="form-control" id="prd_petugas" name="petugas" aria-describedby="emailHelp" placeholder="Masukkan Karyawan">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" name="jml_keluar" aria-describedby="emailHelp" placeholder="Masukkan Jumlah Keluar" required>
