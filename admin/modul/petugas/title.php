      ...
      <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
          ...
          <li class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-user">
                <li>
                  <form class="" action="logout.php" onclick="return confirm('Apakah anda ingin logout?');" method="post">
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <small id="emailHelp" class="form-text text-muted">Masukkan Nama Karyawan</small>
  </div>
    <div class="form-group">
    <label for="exampleInputEmail1">Telepon Karyawan</label>
    ...
    <small id="emailHelp" class="form-text text-muted">Masukkan Telepon Karyawan</small>
  </div>
